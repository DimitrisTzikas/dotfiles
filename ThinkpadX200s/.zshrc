...
alias song='function song(){spotdl --song $1 -o song.m4a}; song'
alias songs='function songs(){for line in `cat $1`; do spotdl --song $line -o song.m4a; done}; songs'
